...
#include <ctime>
#include <cmath>
#include "richards_explicit_fd.hpp"
...
double *fd1d_richards_explicit ( int x_num, double x[], double t, double dt, 
...
//  
//
//    RICHARDS_EXPLICIT_FD: Finite difference solution of 1D richards equation.
//
//  Discussion:
//
//    This program takes one time step to solve the 1D richards equation 
...
//    computed by FD1D_richards_EXPLICIT_CFL.
//
...
//
//    Output, double FD1D_richards_EXPLICIT[X_NUM)], the solution at time T+DT.
//
{
  double *f;
  double *h_new;
...
double fd1d_richards_explicit_cfl ( double k, int t_num, double t_min, double t_max, 
...
//  Purpose:
//
//    FD1D_richards_EXPLICIT_CFL: compute the Courant-Friedrichs-Loewy coefficient.
//
//  Discussion:
//
...
//  Parameters:
//
//    Input, double K, the richards conductivity coefficient.
//
...
//    coordinates.
//
//    Output, double FD1D_richards_EXPLICIT_CFL, the Courant-Friedrichs-Loewy coefficient.
//
{
  double cfl;
  double dx;
...
//
  ...
  {
    cerr << "\n";
    cerr << "FD1D_richards_EXPLICIT_CFL - Fatal error!\n";
